// Returns true if a question should be shown given the current answers.
// Questions without `showIf` are always visible.
export const isQuestionVisible = (question, answers) => {
  if (typeof question.showIf !== "function") return true;
  try {
...
export const QUESTIONS = [
  ...
  },
  {
    ...
    section: "About You",
    question:
      "Do you earn extra income from side hustles (freelance work, small business, trading) in addition to your main income?",
    type: "single",
    options: ["Yes, I have side income", "No, just my main income"],
  },
  {
    id: "q13",
    section: "About You",
    question: "How do you currently handle taxes on your side income?",
    type: "single",
    options: [
      "I file separately myself (e.g. TaxPro Max)",
      "I assume PAYE on my salary covers it",
      "I pay through a tax agent or middleman",
      "I don't pay tax on this income",
      "I don't know how I should pay",
    ],
    showIf: (answers) => answers.q12 === "Yes, I have side income",
  },
  {
    id: "q3",
